    ...
    <DbConnectionDefinition>
      ...
      <ConnectionString>cs2</ConnectionString>
        ...
        public void Can_serialize_a_DbConnectionDefinitionList()
        {
            ...
            StringAssert.Contains("<DefaultName>def</DefaultName>", xml);
            StringAssert.Contains("<Name>nm1</Name>", xml);
            StringAssert.Contains("<ConnectionString>cs1</ConnectionString>", xml);
            StringAssert.Contains("<ProviderName>p1</ProviderName>", xml);
            StringAssert.Contains("<Name>nm2</Name>", xml);
            StringAssert.Contains("<ConnectionString>cs2</ConnectionString>", xml);
            StringAssert.Contains("<ProviderName>p2</ProviderName>", xml);
        }
    }
}